...
describe('ScoreSelector', () => {
  ...
  it('calls onChange with the clicked score', async () => {
    ...
    render(<ScoreSelector criterion={criterion} value={undefined} onChange={onChange} />)
  ...
  it('score bar is 0% width when no value is set', () => {
    const { container } = render(<ScoreSelector criterion={criterion} value={undefined} onChange={vi.fn()} />)
