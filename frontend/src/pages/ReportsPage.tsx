...
const CSV_EXPORTS: CSVExport[] = [
  { key: "pitches", label: "Pitches", endpoint: "/reports/export/pitches" },
  {
    key: "organisations",
    label: "Organisations",
    endpoint: "/reports/export/organisations",
  },
  ...
  { key: "meetings", label: "Meetings", endpoint: "/reports/export/meetings" },
  {
    key: "assessments",
    label: "Assessments",
    endpoint: "/reports/export/assessments",
  },
];
  ...
  if (loading || !summary) {
    return (
      <Layout>
        <PageHeader
          title="Reports"
          description="Pipeline reports and data exports"
        />
    ...
    <Layout>
      ...
      <div className="bg-white rounded-xl border border-navy-100 p-6 mb-8 print:hidden">
        ...
        <p className="text-xs text-navy-400 mb-4">
          Download any dataset as a CSV file — opens in Excel, Google Sheets, or
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-navy-50">
              {filteredPitches.length === 0 ? (
                ...
                filteredPitches.map((p: PitchSummary) => (
                  <tr
                    key={p.id}
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-block text-xs font-medium px-2 py-1 rounded-full ${STAGE_BADGE[p.current_stage] || "bg-gray-100"}`}
                      >
                        {p.stage_label}
                      </span>
                    </td>
